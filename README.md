...
**Submission docs:** [RAG Architecture](docs/submission/rag-architecture.md) · [Pre-Search](docs/submission/pre-search.md) · [AI Cost Analysis](docs/submission/ai-cost-analysis.md)
